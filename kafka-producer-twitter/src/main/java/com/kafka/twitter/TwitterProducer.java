...
/*
 * This is a twitter integration
 * sreach in google for github twitter java to get this code
 */
...
public class TwitterProducer {
	...
	public Client createTwitterClient() {
		...
		//hosts given by twitter to integrate
		/** Declare the host you want to connect to, the endpoint, and authentication (basic auth or oauth) */
		Hosts hosebirdHosts = new HttpHosts(Constants.STREAM_HOST);
		StatusesFilterEndpoint hosebirdEndpoint = new StatusesFilterEndpoint();
		
		// Optional: set up some followings and track terms
		List<String> terms = Lists.newArrayList("by santhosha Kempegowda","climate change","covid");
